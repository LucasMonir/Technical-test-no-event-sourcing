...
### Other info:
> This version of the application uses a CQRS + Repository pattern architecture with the database as source of truth
> and events are not part of the persistence model since event sourcing is being implemented in an alternate repository